https://www.iesdouyin.com/web/api/v2/aweme/post/?sec_uid=MS4wLjABAAAAPCnTQLqza4Xqu-uO7KZHcKuILkO7RRz2oapyOC04AQ0&count=21&max_cursor=0&aid=1128&_signature=3Yp.0AAAgjI6.YfWCo5of92Kf8&dytk=

- `user_id`: 用户 ID，可从 HTML 中提取
- `sec_uid`: 加密后的 userId
- `count`: 视频数量
...
页面加载的 js 可以找到`_signature` 算法;

https://github.com/coder-fly/douyin-signature
