...
➜  redis-5.0.5 redis-server -v
Redis server v=5.0.5 sha=00000000:0 malloc=jemalloc-5.1.0 bits=64 build=a482769540f3f42e
➜  redis-5.0.5 redis-server
...
```basg
cp ~/redis/redis-5.0.5/redis.conf ~/redis/redis.conf
